...
/*=========================== 제네릭(Generic) =========================== */ /*=========================== 패키지 타입 선언 =========================== */ var _lodash = require("lodash");
var _lodashDefault = parcelHelpers.interopDefault(_lodash);
/*=========================== 패키지 타입 선언 =========================== */ /*=========================== 타입 가져오기 / 내보내기 =========================== */ var _user = require("./user");
const a = "123"; /*any는 어떤 타입이 들어가도 괜찮음*/ 
const u = 123;
const any = 1;
const boo = a;
const tuple = [
...
// 따로 타입 추가할 필요가 사라짐
let num = 12;
function add(a, b = 2 /*b:number = 2 를 b = 2 로해도 상관없음 => 타입 추론*/ ) {
    return a + b;
}
/*타입을 굳이 하나하나 다 쓸 이유가 없음 => 타입 추론이 있기 때문
하나하나해도 상관은 없지만 가독성 떨어짐 */ /*=========================== 타입 단언 ===========================*/ // 단언 - 주저하지 아니하고 딱 잘라 말함
// 단언 키워드 - as
// Non-null 단언 연산자 - !
// 1)
...
if (el1) el1.textContent = "hello world";
...
/*=========================== 함수 - 명시적 this =========================== */ /*=========================== 함수 - 오버로딩(Oveloading) =========================== */ // 1)
function add2(a, b) {
    return a + b;
}
function add3(a, b) {
...
/*=========================== 함수 - 오버로딩(Oveloading) =========================== */ /*=========================== 클래스 =========================== */ // 접근 제이자 (Access Modifiers)
...
console.log(toArray('Neo', 'Anderson'), //<string>를 쓰는 이유 -> 따로 타입 추론을 하지 않고 미리 적어 명시적 표현 따로 작성하지 않아도 됨
...
const heropyA = new User5({
    name: 'Heropy',
    age: 85,
    isValid: true
});
const neo2 = new User5({
    name: 'Neo',
    age: 102,
    emails: [
        'neo@naver.com'
...
const fullName1 = (0, _user.getFullName)(heropyTs);
console.log(fullName1);
console.log(heropyTs.isValid) /*=========================== 타입 가져오기 / 내보내기 =========================== */ ;

},{"lodash":"3qBDj","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./user":"g5WXs"}],"3qBDj":[function(require,module,exports,__globalThis) {
var global = arguments[3];
(function() {
...
},{}],"g5WXs":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
